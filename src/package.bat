...
SET TARGET_SOLUTION=OoBDev.Libs.sln
SET TARGET_SOLUTION_NAME=OoBDev.Libs
SET TARGET_WEB_PROJECT=.\Examples\OoBDev.WebApi\OoBDev.WebApi.csproj
SET TARGET_WEB_PROJECT_NAME=OoBDev.WebApi
