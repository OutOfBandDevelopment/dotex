...
/// <summary>
/// Calculates HMAC-SHA512 hashes for message authentication.
/// </summary>
public class HMAC512Calculator : IHMACCalculator
{
    /// <summary>
    /// Calculates the HMAC-SHA512 hash of a message using the provided secret key.
    /// </summary>
    /// <param name="secret">The secret key for HMAC calculation.</param>
    /// <param name="message">The message to hash.</param>
    /// <returns>The HMAC-SHA512 hash as a byte span.</returns>
    ...
    /// <summary>
    /// Calculates the HMAC-SHA512 hash and encodes it as a Base64 string in one operation.
    /// </summary>
    /// <param name="secret">The secret key for HMAC calculation.</param>
    /// <param name="message">The message to hash.</param>
    /// <returns>The Base64-encoded HMAC-SHA512 hash.</returns>
