...
/// <summary>
/// SQL CLR aggregate function that calculates the centroid (mean) of a set of double-precision vectors.
/// </summary>
...
public class CentroidAggregate : IBinarySerialize
{
    private double[] _sum;
    private int _count;
    ...
    public void Merge(CentroidAggregate other)
    {
        if (other != null)
        {
            if (_sum.Length == 0)
