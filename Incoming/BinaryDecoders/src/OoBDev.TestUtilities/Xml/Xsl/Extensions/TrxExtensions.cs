...
namespace OoBDev.TestUtilities.Xml.Xsl.Extensions;
...
public class TrxExtensions
{
    ...
    public XPathNavigator GetTestTargets(XPathNavigator? input)
    {
        ...
        try
        {
            ...
            /*
          <TestMethod codeBase="C:\Repos\mwwhited\OoBDev\src\OoBDev.ExpressionCalculator.Tests\bin\Debug\netcoreapp3.1\OoBDev.ExpressionCalculator.Tests.dll"
                adapterTypeName="executor://mstestadapter/v2" 
                className="OoBDev.ExpressionCalculator.Tests.Parser.Int64ExpressionParserTests"
