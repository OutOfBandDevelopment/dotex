...
namespace OoBDev.ToolKit.Tests.Xml.Xsl.Extensions;
...
public class XPath20FunctionsTests
{
    ...
    public void MaxTest()
    {
        var xml = @"
<Summary>
    <Class>OoBDev.Apple2.Text.Apple2Encoding</Class>
    <Assembly>OoBDev.Apple2</Assembly>
    <Files>
      <File>C:\Repos\mwwhited\OoBDev\src\OoBDev.Apple2\Text\Apple2Encoding.cs</File>
    </Files>
    ...
    <Title>C:\Repos\mwwhited\OoBDev\src\..\src\OoBDev.sln - (0.2.0-beta.192)</Title>
  </Summary>";
