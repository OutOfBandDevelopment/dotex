...
namespace OoBDev.ToolKit.Tests.Xml.XPath;
...
public class MergedXPathNavigatorTests
{
    ...
    {
        var di1 = new DirectoryInfo(@"C:\Repos\mwwhited\OoBDev\templates").ToNavigable();
        var di2 = new DirectoryInfo(@"C:\Repos\mwwhited\OoBDev\docs\Code").ToNavigable();
