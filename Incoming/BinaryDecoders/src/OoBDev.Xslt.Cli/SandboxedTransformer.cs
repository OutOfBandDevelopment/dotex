using OoBDev.CodeAnalysis.CSharp;
using OoBDev.CodeAnalysis.DacFx;
using OoBDev.CodeAnalysis.StructuredLog;
using OoBDev.CodeAnalysis.VisualBasic;
using OoBDev.Templating.Html;
using OoBDev.TestUtilities.Xml.Xsl.Extensions;
using OoBDev.Text.Json;
using OoBDev.ToolKit.IO;
using OoBDev.ToolKit.Xml.Xsl;
using OoBDev.ToolKit.Xml.Xsl.Extensions;
using OoBDev.Yaml;
using System;
using System.IO;
using System.Xml.XPath;

namespace OoBDev.Xslt.Cli;
